...
for (i = 0; i < githubData.length; i++) {
    if(githubData[i].payload.hasOwnProperty("commits")) {
        totalCommits = totalCommits + githubData[i].payload.commits.length
...
console.log("Number of Pull Request Events: " + pullRequestEvent)
console.log("Number of Push Request Events: " + pushEvent)
console.log("Number of Delete Events: " + issueCommentEvent)
console.log("Number of Issue Comment Events: " + deleteEvent)
console.log("Number of Create Events: " + createEvent)
...
for (i = 0; i < githubData.length; i++) {
    if(githubData[i].type === "PullRequestEvent") {
        userList.push(githubData[i].payload.pull_request.user.login)
    }
}
...
for (i = 0; i < githubData.length; i++) {
    if(githubData[i].payload.hasOwnProperty("commits") && githubData[i].payload.commits.length > greatestNumber) {
        greatestNumber = githubData[i].payload.commits.length
    } else if(githubData[i].type === "PullRequestEvent" && githubData[i].payload.pull_request.commits > greatestNumber) {
        greatestNumber = githubData[i].payload.pull_request.commits
    }
}
